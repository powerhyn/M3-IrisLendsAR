...
- [ ] 데모 빌드 (진행 중 — NDK 컴파일 포함)
- [ ] 실기기 S10 Ultra: 슬라이더 조합 A/B (턱슬림×얼굴축소), 렌즈 정합 육안
- [ ] 내부 taper 튜닝 (실기기 체감 기반)
- [ ] "눈꼬리 높이(356/127)부터 시작"은 눈 고정과 양립 불가로 454/234(귀 중간 높이)까지만 — 실기기에서 시작 높이 부족하면 재논의
