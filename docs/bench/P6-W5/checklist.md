...
**원본 녹화 9개 → 후편집 후 클립 36개 (`clip_01.mp4` ~ `clip_36.mp4` 무작위 ID)**
...
- [ ] **녹화** — 9개 원본 take (§5.6: 12초씩, A→B→C→D 연속 토글). **촬영 전 native active 로그 확인 (F-01 가드)**
- [ ] **후편집** — 36 클립 분리 + 5초 trim + 무작위 ID 부여 + 정답표 별도 저장
- [ ] **평가** — 평가자 3명 × 36 클립 = 108 응답 (`ratings_template.csv` 사용)
